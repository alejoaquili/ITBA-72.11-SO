...
```
    ...
    a3b852a22b2c        agodio/itba-so-multiarch:3.1   "bash"              17 seconds ago      Up 16 seconds                           goofy_hamilton
```
...
```
alias dcrun="docker run -v ${PWD}:/root --privileged -ti --name SO agodio/itba-so-multiarch:3.1"
